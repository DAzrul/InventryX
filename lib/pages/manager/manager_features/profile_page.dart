...
// Gantikan import ini ikut struktur folder projek anda
import '../../../pages/login_page.dart';
import 'change_password_profile.dart';
import 'edit_profile_page.dart';

// ==========================================================
// KELAS WIDGET PEMBANTU (Header, Contact, Actions)
// ==========================================================
...
class ContactInformationSection extends StatelessWidget {
  ...
  const ContactInformationSection({super.key, required this.email, required this.phoneNo});
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadUserProfile() async {
    // Jika username kosong, jangan query (untuk elak error)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        automaticallyImplyLeading: false, // Disembunyikan sebab kita dalam BottomNav
        actions: [
          IconButton(
